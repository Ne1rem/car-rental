  ...
  return (
    ...
    <div className={css.HomeDivText}>
      <div className={css.HomeimageWrapper}>
        <img src={!img ? photoLink : img} alt="car_image" className={css.HomecarImage} />
      </div>
      ...
      <div className={css.Hometitle}>
        <p>
          ...
          <span className={css.Homeyear}>{year}</span>
        </p>
        <p className={css.Homeprice}>{rentalPrice}</p>
      </div>
      ...
      <button
        type="button"
        className={css.HomelearnMoreBtn}
